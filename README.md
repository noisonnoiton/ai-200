...
AI-200 Azure AI Cloud Developer Associate를 위한 한국어 하루 세미나 자료입니다.
...
이 저장소는 하루 세미나용 overview입니다. 실제 시험 준비에는 Python SDK, Azure resource 배포, vector query, messaging, OpenTelemetry, KQL 실습이 추가로 필요합니다. Exam dump나 실제 시험 문항을 포함하지 않습니다.